...
/**
 * Behat grade related step definition overrides for the idef theme.
 *
 * @package    theme_idef
 * @category   test
...
/**
 * Behat grade overrides for the idef theme.
 *
 * @package    theme_idef
 * @category   test
 * @copyright  2019 by IDEF
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_idef_behat_grade extends behat_grade {

...
/**
 * Override definitions for the upload repository type for the idef theme.
 *
 * @package    theme_idef
 * @category   test
...
/**
 * Override step definitions to deal with the upload repository in the idef theme.
 *
 * @package    theme_idef
 * @category   test
 * @copyright  2019 by IDEF
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_idef_behat_repository_upload extends behat_repository_upload {
